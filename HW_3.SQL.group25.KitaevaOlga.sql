...
select avg(monthly_salary) as "Средняя зарплата всех Junior специалистов"
...
select count(re.employee_id) as "Количество QA инженеров"
from employees e left join roles_employee re on e.id = re.employee_id 
                 left join roles r on re.role_id = r.id
                 left join employee_salary es on es.employee_id = re.employee_id 
                 left join salary s on s.id = es.salary_id  
...
select count(re.employee_id) as "Количество Middle специалистов"
from employees e left join roles_employee re on e.id = re.employee_id 
                 left join roles r on re.role_id = r.id
                 left join employee_salary es on es.employee_id = re.employee_id 
                 left join salary s on s.id = es.salary_id  
...
select count(re.employee_id) as "Количество разработчиков"
from employees e left join roles_employee re on e.id = re.employee_id 
                 left join roles r on re.role_id = r.id
                 left join employee_salary es on es.employee_id = re.employee_id 
                 left join salary s on s.id = es.salary_id  
